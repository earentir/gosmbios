// Package type18 implements SMBIOS Type 18 - 32-Bit Memory Error Information
...
func Parse(s *gosmbios.Structure) (*MemoryError32, error) {
	...
	info := &MemoryError32{
		...
		MemoryArrayErrorAddress:   s.GetDWord(0x0B),
		DeviceErrorAddress:        s.GetDWord(0x0F),
		ErrorResolution:   s.GetDWord(0x13),
	}
...
func (m *MemoryError32) IsAddressUnknown() bool {
	return m.MemoryArrayErrorAddress == 0x80000000
}
...
func (m *MemoryError32) IsDeviceAddressUnknown() bool {
	return m.DeviceErrorAddress == 0x80000000
}
